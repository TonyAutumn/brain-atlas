...
const ALLEN={name:'Allen Human 2020',url:'https://community.brain-map.org/t/allen-human-reference-atlas-3d-2020-new/405',type:'宏观解剖参考分割',description:'由 Allen 官方松果体标签生成，源空间为 MNI ICBM152 2009b 非线性对称模板（0.5 mm 体素）；并非概率图或个体边界。原始坐标保留，与其他模板版本的叠加只用于空间学习。'};
export const ATLAS = {allen2020:ALLEN,julich:{name:'Julich-Brain 3.1',url:'https://doi.org/10.1126/science.abb4588',type:'细胞构筑分区',description:'从群体参考分区图提取的表面。分区来源于组织学细胞构筑；当前显示不包含个体差异的完整概率分布。'},cit168:{name:'CIT168',url:'https://doi.org/10.1038/sdata.2018.63',type:'皮层下概率图谱',description:'来源提供的概率等值面经过平滑与网格简化；其范围是参考边界，不代表每个个体中相同的核团边界。'},aal:{name:'AAL',url:'https://doi.org/10.1006/nimg.2001.0978',type:'宏观解剖分区',description:'小脑分叶的宏观解剖参考。与组织学定义的深部小脑核团来自不同分区体系。'}};
const SPECIAL={
 'Pineal body':'松果体',
